...
def print_demon(demon_dict):
    ...
    output = f"""
    Tremble at the sight of {demon_dict["name"]}!
    Behold, {demon_dict["feature_1"]} and {demon_dict["feature_2"]}.
    This {demon_dict["affinity"]} demon has a {demon_dict["aspect"]} aspect.
    This demon desires {demon_dict["desire"]} above all else!
    """
    print(output)
    return output
